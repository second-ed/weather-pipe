...
class BronzeWind:
    ...
    wind_dir_id: int = attrs.field(validator=[instance_of(str), max_len(5)])


@attrs.define
class BronzeDesc:
    text_id: int = attrs.field(validator=[instance_of(int), ge(0), lt(21)])
    text: int = attrs.field(validator=[instance_of(str), max_len(30)])


@attrs.define
class BronzeIcon:
    icon_id: int = attrs.field(validator=[instance_of(int), ge(0), lt(21)])
    icon: int = attrs.field(validator=[instance_of(str)])
